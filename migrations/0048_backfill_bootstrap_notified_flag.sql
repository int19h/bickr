-- Backfill for the column added by 0047, kept in its own migration so a failure
-- retries cleanly: this UPDATE is idempotent, whereas re-running 0047's ALTER is
-- not.
--
