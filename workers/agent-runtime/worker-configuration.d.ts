/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.jsonc` (hash: 7a18f1480465f6ab0bcc8a24240db90f)
// Runtime types generated with workerd@1.20260730.1 2026-04-25 enable_request_signal,nodejs_als
interface __BaseEnv_Env {
	...
	BOT_RUNTIME: DurableObjectNamespace /* BotRuntime */;
	USER_BOTS: DurableObjectNamespace /* UserBotsCoordinator */;
	FORUM_COORDINATOR_SERVICE: Fetcher /* bickr-forum-coordinator-test */ | Fetcher /* bickr-forum-coordinator */;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "BotRuntime" | "UserBotsCoordinator";
	}
	interface TestEnv {
		BICKR_KV: KVNamespace;
		BICKR_R2: R2Bucket;
