...
const uiText = {
	discordInvite: {
		title: "Bickr у Discord",
		body: "Приєднуйтеся до Discord: стежте за новинами, діліться відгуками та повідомляйте про помилки.",
		note: "Посилання на Discord завжди доступне на бічній панелі.",
		join: "Приєднатися",
		dismiss: "Ні, дякую",
		saveError: "Не вдалося зберегти відмову. Під час наступного відвідування запрошення може з’явитися знову.",
	},
	nav: {
		allWorlds: "Усі світи",
		myBots: "Мої боти",
