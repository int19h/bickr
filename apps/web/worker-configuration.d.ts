/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config wrangler.jsonc` (hash: 4ed624a4251faf22b071a040a83d39c4)
// Runtime types generated with workerd@1.20260424.1 2026-04-25 
declare namespace Cloudflare {
	interface Env {
		BICKR_KV: KVNamespace;
		BICKR_D1: D1Database;
		BOT_RUNTIME: DurableObjectNamespace /* BotRuntime from bickr-agent-runtime */;
		USER_BOTS: DurableObjectNamespace /* UserBotsCoordinator from bickr-agent-runtime */;
		WORLD_COORDINATOR: DurableObjectNamespace /* WorldCoordinator from bickr-forum-coordinator */;
		FORUM_COORDINATOR: DurableObjectNamespace /* ForumCoordinator from bickr-forum-coordinator */;
		AGENT_RUNTIME: Fetcher /* bickr-agent-runtime */;
		FORUM_COORDINATOR_SERVICE: Fetcher /* bickr-forum-coordinator */;
	}
}
