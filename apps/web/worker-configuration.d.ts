/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.jsonc` (hash: 888dfefb9011ced752a678cc64dcf49b)
// Runtime types generated with workerd@1.20260730.1 2026-04-25 enable_request_signal
interface __BaseEnv_Env {
	BICKR_KV: KVNamespace;
	BICKR_R2: R2Bucket;
	BICKR_D1: D1Database;
	BICKR_ENVIRONMENT: "test" | "production";
	BICKR_PRODUCTION_ORIGIN: "https://bickr.social";
	BICKR_R2_PUBLIC_BASE_URL: "https://test-assets.bickr.social" | "https://assets.bickr.social";
	GITHUB_REDIRECT_URI: "https://test.bickr.social/api/auth/github/callback" | "https://bickr.social/api/auth/github/callback";
	GOOGLE_REDIRECT_URI: "https://test.bickr.social/api/auth/google/callback" | "https://bickr.social/api/auth/google/callback";
	TEST_AUTH_ALLOWED_HOSTS?: "test.bickr.social,test.bickr.pages.dev";
	TEST_ENTRY_MODE: "migration" | "disabled";
	GITHUB_CLIENT_ID: string;
	GITHUB_CLIENT_SECRET: string;
	TEST_AUTH_SECRET: string;
	GOOGLE_CLIENT_ID: string;
	GOOGLE_CLIENT_SECRET: string;
	BOT_RUNTIME: DurableObjectNamespace /* BotRuntime from bickr-agent-runtime-test */ | DurableObjectNamespace /* BotRuntime from bickr-agent-runtime */;
	USER_BOTS: DurableObjectNamespace /* UserBotsCoordinator from bickr-agent-runtime-test */ | DurableObjectNamespace /* UserBotsCoordinator from bickr-agent-runtime */;
	WORLD_COORDINATOR: DurableObjectNamespace /* WorldCoordinator from bickr-forum-coordinator-test */ | DurableObjectNamespace /* WorldCoordinator from bickr-forum-coordinator */;
	FORUM_COORDINATOR: DurableObjectNamespace /* ForumCoordinator from bickr-forum-coordinator-test */ | DurableObjectNamespace /* ForumCoordinator from bickr-forum-coordinator */;
	AGENT_RUNTIME: Fetcher /* bickr-agent-runtime-test */ | Fetcher /* bickr-agent-runtime */;
	FORUM_COORDINATOR_SERVICE: Fetcher /* bickr-forum-coordinator-test */ | Fetcher /* bickr-forum-coordinator */;
}
declare namespace Cloudflare {
	interface PreviewEnv {
		...
		GITHUB_REDIRECT_URI: "https://test.bickr.social/api/auth/github/callback";
		GOOGLE_REDIRECT_URI: "https://test.bickr.social/api/auth/google/callback";
		TEST_AUTH_ALLOWED_HOSTS: "test.bickr.social,test.bickr.pages.dev";
		...
		GOOGLE_CLIENT_ID: string;
		GOOGLE_CLIENT_SECRET: string;
		BOT_RUNTIME: DurableObjectNamespace /* BotRuntime from bickr-agent-runtime-test */;
		USER_BOTS: DurableObjectNamespace /* UserBotsCoordinator from bickr-agent-runtime-test */;
		WORLD_COORDINATOR: DurableObjectNamespace /* WorldCoordinator from bickr-forum-coordinator-test */;
		FORUM_COORDINATOR: DurableObjectNamespace /* ForumCoordinator from bickr-forum-coordinator-test */;
		AGENT_RUNTIME: Fetcher /* bickr-agent-runtime-test */;
		FORUM_COORDINATOR_SERVICE: Fetcher /* bickr-forum-coordinator-test */;
	}
